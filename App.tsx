...
import { DashboardNavigator,ProductDetailNavigator,FullScreenImageViewerNavigator,CartNavigator,ProductNavigator,FavouriteNavigator,SubCategoryNavigator,HomeTabNavigator,categoryTabNavigator,FavouriteTabNavigator ,SettingTabNavigator,RegisterNavigator,LoginNavigator,BillingInfoNavigator,SubCategoryMoreNavigator,orderHistoryNavigator,orderDetailHistoryNavigator} from '@constants/navigator/navigation-stack';
      ...
      <PersistGate loading={null} persistor={persistor}>
        <NavigationContainer>
          ...
          <Stack.Navigator initialRouteName={DashboardNavigator} >
            ...
            <Stack.Screen name={orderDetailHistoryNavigator} component={OrderDetailScreen} options={{ headerShown: false }} />
