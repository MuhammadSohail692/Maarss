...
export const fetchSubCategoriesData = createAsyncThunk('subcategories-slice/fetchSubCategoriesData', async ({categoryId,pageNo}) => {
  try {
...
const subCategoriesDataSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchSubCategoriesData.rejected, (state, action) => {
        console.log("errore")
...
export const { clearSubCategoryData } = subCategoriesDataSlice.actions;
export default subCategoriesDataSlice.reducer;
